...
\begin{frame}{Phantom}
\begin{center}
  \includegraphics[width=0.7\textwidth, interpolate=true]{figs/phantom.png}
\end{center}
\end{frame}

\begin{frame}{Reconstructed with data from single-view epi-illumination NA = 0.7}
\begin{center}
  \includegraphics[width=0.7\textwidth, interpolate=true]{figs/phantom_epi_recon.png}
\end{center}
\end{frame}

\begin{frame}{Reconstructed with data from diSPIM}
\begin{center}
  \includegraphics[width=0.7\textwidth, interpolate=true]{figs/phantom_dispim_recon.png}
\end{center}
\end{frame}
