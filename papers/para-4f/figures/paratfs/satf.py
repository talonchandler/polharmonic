...
for col in range(cols):
    ...
    ax.plot(nucr, paratf.satf(nucr, 0, NA=alpha), '-', c=[1, 0, 0], lw=0.5)
    ax.plot(nucr, paratf.satf(nucr, 2, NA=alpha), '-', c=[0, 0, 1], lw=0.5)
    ...
    ax.yaxis.set_ticks([-0.5, -0.25, 0, 0.25, 0.5, 0.75, 1])
    if col == 0:
