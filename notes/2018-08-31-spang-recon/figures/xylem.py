...
in_folder = '/Users/Talon/local-data/2018-dispim-min/20180725_plantCells/Cell1_processed/RegisteredSmall/'
out_folder = './xylem-recon/'
import os
...
# Adjust input power (already corrected in RegisteredSmall)
