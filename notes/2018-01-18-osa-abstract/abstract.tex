...
\author{Talon Chandler, Min Guo, Shalin Mehta, Abhishek Kumar,\\ Hari Shroff, Rudolf Oldenbourg, Patrick J. La Rivi\`ere}

\address{Department of Radiology, University of Chicago, Chicago, Illinois 60637, USA.\\Section on High Resolution Optical Imaging, National Institute of Biomedical Imaging\\ and Bioengineering, National Institutes of Health, Bethesda, Maryland 20892, USA.\\ Chan Zuckerberg Biohub, San Francisco, California 94158, USA.\\ Bell Center, Marine Biological Laboratory, Woods Hole, Massachusetts 02543, USA.\\ Whitman Center, Marine Biological Laboratory, Woods Hole, Massachusetts 02543, USA.\\ Department of Physics, Brown University, Providence, Rhode Island 02912, USA.}
\email{*talonchandler@talonchandler.com} %% email address is required

\begin{abstract}
  We show that polarized fluorescence microscopes collect data in the angular
  frequency domain. We use this result to propose and demonstrate efficient
  algorithms for reconstructing three-dimensional fluorophore orientations from
  polarized multiview microscope data.
\end{abstract}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=17cm]{figs/asym_dispim/data.pdf}
\caption{Sample figure with preferred style for labeling parts.}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=17cm]{figs/asym_dispim/recon.pdf}
\caption{Sample figure with preferred style for labeling parts.}
\end{figure}
